...
export function demoSkillsOverview(): SkillsOverview {
  ...
  return {
    ...
    period_comparison: {
      ...
      current_operators: 3,
      previous_operators: 2,
      current_top3_share: 1,
      previous_top3_share: 0.8,
      current_untracked_share: 14 / 59,
      previous_untracked_share: 0.2,
      current_company_skill_count: 2,
      previous_company_skill_count: 1,
